...
void Graphics::SetPixel(int32_t x, int32_t y, COLORREF color)//красим
{
...
void Graphics::DrawLine(float x0, float y0, float x1, float y1, COLORREF color)//рисуем линии
{
...
void Graphics::DrawPoly(std::vector<std::array<float, 2>> vertices, COLORREF color)//рисуем поверхность
{
